...
const command = new WinRateCompareCommand();
...
describe("command properties", () => {
  it("returns the expected description", () => {
    expect(command.description).toBe("Win Rate Comparison between players.");
  });
...
describe("cliMode", () => {
  it("executes for all modes", async () => {
    ...
    const expectedFiles = [
      "winRate-playerOne-playerTwo-game-mode-one.png",
      "winRate-playerOne-playerTwo-game-mode-one.svg",
      "winRate-playerOne-playerTwo-game-mode-two.png",
      "winRate-playerOne-playerTwo-game-mode-two.svg"
    ];
