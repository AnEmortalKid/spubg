...
describe("cliMode", () => {
  it("executes for all modes", async () => {
    ...
    expectFileExists(
      ...
      "charts/",
      "trend/",
      "adr_playerOne-KD-game-mode-one.png"
    );
    ...
    expectFileExists(
      ...
      "charts/",
      "trend/",
      "adr_playerOne-KD-game-mode-one.svg"
    );
    ...
    expectFileExists(
      ...
      "charts/",
      "trend/",
      "adr_playerOne-KD-game-mode-two.png"
    );
  ...
  it("executes only for the filtered mode", async () => {
    ...
    expectFileMissing(
      ...
      "charts/",
      "trend/",
      "adr_playerTwo-KD-game-mode-one.png"
    );
    expectFileMissing(
      "temp/",
      "charts/",
      "trend/",
      "adr_playerTwo-KD-game-mode-one.svg"
    );
    ...
    expectFileExists(
      ...
      "charts/",
      "trend/",
      "adr_playerTwo-KD-game-mode-two.png"
    );
